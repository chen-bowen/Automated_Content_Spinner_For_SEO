...
class ContentSpinner:
    ...
    def predict_word(self, context):
        ...
        possible_words = self.language_model[context].keys()
        sample_distribution = self.language_model[context].values()
